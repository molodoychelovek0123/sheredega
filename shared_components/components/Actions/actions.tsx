            ...
            element = (
              <Link key={index} href={action.link ? action.link : "/"}>
                <button
                  ...
                  className={`z-10 relative flex items-center px-7 py-3 font-semibold text-lg transition duration-150 ease-out  rounded-lg transform focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 whitespace-nowrap text-blue-500 bg-white hover:bg-gray-50 bg-gradient-to-r from-gray-50 to-white hover:to-gray-100`}
                >
                  {action.label}
                  {action.icon && (
                    <BiRightArrowAlt
          ...
          if (action.type === "link" || action.type === "linkExternal") {
            element = (
              <Link
                ...
                data-tina-field={tinaField(action)}
                className={`group inline-flex items-center font-semibold text-lg transition duration-150 ease-outtext-white  hover:text-gray-50`}
                style={{
