...
export const CardItem = ({ text, subtext, image = "https://via.placeholder.com/307x307", url, hide }: Props) => {
  ...
  return (
    <motion.a
      ...
      {subtext &&
        <div className="opacity-40 text-black text-base  lg:text-lg leading-tight lg:leading-snug font-normal">{subtext}</div>}
